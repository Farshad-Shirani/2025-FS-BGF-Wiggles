...
load('Results\sol_climateChange_downslope_strong')
...
%%%%%%%%%%%%%%%%%%%
incrementSize = 6; % Size of increments in plotting curves. For example, if time samples in simulationParameters.times increase with steps pf size 2, and incrementSize is 10, then curves are plotted at every 2*10 = 20T
...
Q1_edgeIndex = dsearchn(x', 18.6); % N1(:,end)=0 at approximately x=18.6
Q2_edgeIndex = dsearchn(x', 14); % N2(:,end)=0 at approximately x=14
