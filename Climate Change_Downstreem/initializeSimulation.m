...
T = 200; %final time
storageTimes = 0 : 1 : T; % solution storage times. Solutins are sored at closest time samples depending on Dt
...
R2 = 1.1 * ones(I, 1);  % intrinsic rate of increase for optimally adapted individuals of population 2
...
load('Data\sol_stableLimit_downstream.mat', 'populations' ) 

sampleIndex = 350; % the sample taken from the population at time t = 700 T
