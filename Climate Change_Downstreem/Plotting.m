...
load('Results\sol_climateChange_downstream_10_5.mat')
...
%%%%%%%%%%%%%%%%%%%
incrementSize = floor(numSamples/10); % Size of increments in plotting curves. For example, if time samples in simulationParameters.times increase with steps pf size 2, and incrementSize is 10, then curves are plotted at every 2*10 = 20T
%%%%%%%%%%%%%%%%%%%
...
Q1_edgeIndex = dsearchn(x', 30); % N1(:,end)=0 at approximately x=30
Q2_edgeIndex = dsearchn(x', 20); % N2(:,end)=0 at approximately x=20
