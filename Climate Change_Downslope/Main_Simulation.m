...
shiftAmplitude = 8; % amplitude of climatic shift in Q_opt 
...
%save('Results\sol_climateChange_downslope_strong.mat', 'populations', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
