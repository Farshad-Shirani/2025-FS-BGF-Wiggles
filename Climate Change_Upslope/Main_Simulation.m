...
shiftAmplitude = 4; % amplitude of climatic shift in Q_opt 
...
%save('Results\sol_climateChange_upslope_moderate.mat', 'populations', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
