...
load('Results\sol_stableLimit_upstream.mat')
...
plot(x, N2(:,end-150)','Color', darkBlue, 'LineWidth', 2); %t=700 T
plot(x, N1(:,end-150)','Color', darkRed, 'LineWidth', 2);% t=700T
...
figure, 
plot(x, Q1(:,end -150)','Color', transparentRed, 'LineWidth', 1.5);
hold on
plot(x, Q2(:,end - 150)','Color', transparentBlue, 'LineWidth', 1.5);
% Q1_edgeIndex = dsearchn(x', 19); % N1(:,end)=0 at approximately x=20
% Q2_edgeIndex = dsearchn(x', -19); % N2(:,end)=0 at approximately x=-20
...
Q1_edgeIndex = dsearchn(x', 50); % N1(:,700)=0 at approximately x=50
Q2_edgeIndex = dsearchn(x', 40); % N2(:,700)=0 at approximately x=40
plot(x(1:Q1_edgeIndex), Q1(1:Q1_edgeIndex, end-150)','Color', darkRed, 'LineWidth', 1.5);
plot(x(Q2_edgeIndex:end), Q2(Q2_edgeIndex:end, end-150)','Color', darkBlue, 'LineWidth', 1.5);
plot(x, modelParameters.Q_opt','k', 'LineWidth', 1);
