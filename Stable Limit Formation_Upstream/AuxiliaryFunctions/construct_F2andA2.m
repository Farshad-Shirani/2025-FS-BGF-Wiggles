...
R2N1_K2 = R2_K2 .* N1;
R2N2_K2 = R2_K2 .* N2;
R1C11N1_K1 = R1N1_K1 .* C11;
R1C12N2_K1 = R1N2_K1 .* C12;
R2C21N1_K2 = R2N1_K2 .* C21;
R2C22N2_K2 = R2N2_K2 .* C22;
R1M11N1_K1 = R1N1_K1 .* M11;
R1M12N2_K1 = R1N2_K1 .* M12;
R2M21N1_K2 = R2N1_K2 .* M21;
R2M22N2_K2 = R2N2_K2 .* M22;
R1M11C11N1_K1 = R1C11N1_K1 .* M11;
R1M12C12N2_K1 = R1C12N2_K1 .* M12;
R2M21C21N1_K2 = R2C21N1_K2 .* M21;
R2M22C22N2_K2 = R2C22N2_K2 .* M22;
R1M11C11_K1 = R1_K1 .* M11 .* C11;
R1M12C12_K1 = R1_K1 .* M12 .* C12;
R2M21C21_K2 = R2_K2 .* M21 .* C21;
R2M22C22_K2 = R2_K2 .* M22 .* C22;

G1 = R1(:) - R1M11C11N1_K1 - R1M12C12N2_K1 - ( Q1mQ_opt.^2 + V1 ) / (2 * V_s);
G2 = R2(:) - R2M21C21N1_K2 - R2M22C22N2_K2 - ( Q2mQ_opt.^2 + V2 ) / (2 * V_s);
R1mG1 =  R1(:) - G1;
R2mG2 =  R2(:) - G2;
H1 = R1mG1 .* Q1 - R1M11C11N1_K1 .* L11 - R1M12C12N2_K1 .* L12 + E1;
H2 = R2mG2 .* Q2 - R2M21C21N1_K2 .* L21 - R2M22C22N2_K2 .* L22 + E2;
W1 = R1mG1 .* V1mQ1_squared - R1M11C11N1_K1 .* S11 - R1M12C12N2_K1 .* S12 + Y1;
W2 = R2mG2 .* V2mQ2_squared - R2M21C21N1_K2 .* S21 - R2M22C22N2_K2 .* S22 + Y2;
...
dG1_dN1 = -R1M11C11_K1;
dG1_dQ1 = -R1C12N2_K1 .* dM12_dQ1 - Q1mQ_opt / V_s;
dG1_dV1 = -R1C11N1_K1 .* dM11_dV1 - R1M11N1_K1 .* dC11_dV1 - R1C12N2_K1 .* dM12_dV1 - R1M12N2_K1 .* dC12_dV1 - 1 / (2 * V_s);
dG1_dN2 = -R1M12C12_K1;
dG1_dQ2 = -R1C12N2_K1 .* dM12_dQ2;
dG1_dV2 = -R1C12N2_K1 .* dM12_dV2 - R1M12N2_K1 .* dC12_dV2;

dG2_dN1 = -R2M21C21_K2;
dG2_dQ1 = -R2C21N1_K2 .* dM21_dQ1;
dG2_dV1 = -R2C21N1_K2 .* dM21_dV1 - R2M21N1_K2 .* dC21_dV1;
dG2_dN2 = -R2M22C22_K2;
dG2_dQ2 = -R2C21N1_K2 .* dM21_dQ2 - Q2mQ_opt / V_s;
dG2_dV2 = -R2C21N1_K2 .* dM21_dV2 - R2M21N1_K2 .* dC21_dV2 - R2C22N2_K2 .* dM22_dV2 - R2M22N2_K2 .* dC22_dV2 - 1 / (2 * V_s);

R1N1_K1dM11C11_dV1 = R1C11N1_K1 .* dM11_dV1 + R1M11N1_K1 .* dC11_dV1;
R1N2_K1dM12C12_dV1 = R1C12N2_K1 .* dM12_dV1 + R1M12N2_K1 .* dC12_dV1;
R1N2_K1dM12C12_dV2 = R1C12N2_K1 .* dM12_dV2 + R1M12N2_K1 .* dC12_dV2;
R2N1_K2dM21C21_dV1 = R2C21N1_K2 .* dM21_dV1 + R2M21N1_K2 .* dC21_dV1;
R2N1_K2dM21C21_dV2 = R2C21N1_K2 .* dM21_dV2 + R2M21N1_K2 .* dC21_dV2;
R2N2_K2dM22C22_dV2 = R2C22N2_K2 .* dM22_dV2 + R2M22N2_K2 .* dC22_dV2;

dH1_dN1 = -dG1_dN1 .* Q1 - R1M11C11_K1 .* L11;
dH1_dQ1 = -dG1_dQ1 .* Q1 + R1mG1 - R1M11C11N1_K1 .* dL11_dQ1 - R1C12N2_K1 .* ( dL12_dQ1 .* M12 + L12 .* dM12_dQ1 ) + dE1_dQ1;
dH1_dV1 = -dG1_dV1 .* Q1 - R1M11C11N1_K1 .* dL11_dV1 - L11 .* R1N1_K1dM11C11_dV1 - R1M12C12N2_K1 .* dL12_dV1 - L12 .* R1N2_K1dM12C12_dV1 + dE1_dV1;
dH1_dN2 = -dG1_dN2 .* Q1 - R1M12C12_K1 .* L12; 
dH1_dQ2 = -dG1_dQ2 .* Q1 - R1C12N2_K1 .* ( dL12_dQ2 .* M12 + L12 .* dM12_dQ2 );
dH1_dV2 = -dG1_dV2 .* Q1 - R1M12C12N2_K1 .* dL12_dV2 - L12 .* R1N2_K1dM12C12_dV2;

dH2_dN1 = -dG2_dN1 .* Q2 - R2M21C21_K2 .* L21;
dH2_dQ1 = -dG2_dQ1 .* Q2 - R2C21N1_K2 .* ( dL21_dQ1 .* M21 + L21 .* dM21_dQ1 );
dH2_dV1 = -dG2_dV1 .* Q2 - R2M21C21N1_K2 .* dL21_dV1 - L21 .* R2N1_K2dM21C21_dV1;
dH2_dN2 = -dG2_dN2 .* Q2 - R2M22C22_K2 .* L22;
dH2_dQ2 = -dG2_dQ2 .* Q2 + R2mG2 - R2C21N1_K2 .* ( dL21_dQ2 .* M21 + L21 .* dM21_dQ2 ) - R2M22C22N2_K2 .* dL22_dQ2 + dE2_dQ2;
dH2_dV2 = -dG2_dV2 .* Q2 - R2M21C21N1_K2 .* dL21_dV2 - L21 .* R2N1_K2dM21C21_dV2 - R2M22C22N2_K2 .* dL22_dV2 - L22 .*R2N2_K2dM22C22_dV2 + dE2_dV2;

dW1_dN1 = -dG1_dN1 .* V1mQ1_squared - R1M11C11_K1 .* S11;
dW1_dQ1 = -dG1_dQ1 .* V1mQ1_squared - 2 * Q1 .* R1mG1 - R1M11C11N1_K1 .* dS11_dQ1 - R1C12N2_K1 .* ( dS12_dQ1 .* M12 + S12 .* dM12_dQ1 ) + dY1_dQ1;
dW1_dV1 = -dG1_dV1 .* V1mQ1_squared + R1mG1 - R1M11C11N1_K1 .* dS11_dV1 - S11 .* R1N1_K1dM11C11_dV1 - R1M12C12N2_K1 .* dS12_dV1 - S12 .* R1N2_K1dM12C12_dV1 + dY1_dV1;
dW1_dN2 = -dG1_dN2 .* V1mQ1_squared - R1M12C12_K1 .* S12; 
dW1_dQ2 = -dG1_dQ2 .* V1mQ1_squared - R1C12N2_K1 .* ( dS12_dQ2 .* M12 + S12 .* dM12_dQ2 );
dW1_dV2 = -dG1_dV2 .* V1mQ1_squared - R1M12C12N2_K1 .* dS12_dV2 - S12 .* R1N2_K1dM12C12_dV2;

dW2_dN1 = -dG2_dN1 .* V2mQ2_squared - R2M21C21_K2 .* S21;
dW2_dQ1 = -dG2_dQ1 .* V2mQ2_squared - R2C21N1_K2 .* ( dS21_dQ1 .* M21 + S21 .* dM21_dQ1 );
dW2_dV1 = -dG2_dV1 .* V2mQ2_squared - R2M21C21N1_K2 .* dS21_dV1 - S21 .* R2N1_K2dM21C21_dV1;
dW2_dN2 = -dG2_dN2 .* V2mQ2_squared - R2M22C22_K2 .* S22;
dW2_dQ2 = -dG2_dQ2 .* V2mQ2_squared - 2 * Q2 .* R2mG2 - R2C21N1_K2 .* ( dS21_dQ2 .* M21 + S21 .* dM21_dQ2 ) - R2M22C22N2_K2 .* dS22_dQ2 + dY2_dQ2;
dW2_dV2 = -dG2_dV2 .* V2mQ2_squared + R2mG2 - R2M21C21N1_K2 .* dS21_dV2 - S21 .* R2N1_K2dM21C21_dV2 - R2M22C22N2_K2 .* dS22_dV2 - S22 .* R2N2_K2dM22C22_dV2 + dY2_dV2;
