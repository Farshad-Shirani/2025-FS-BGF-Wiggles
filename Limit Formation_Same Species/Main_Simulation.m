...
%save('Results\sol_sameSpecies_moderateGradient.mat', 'populations', 'modelParameters', 'simulationParameters', 'discretizationParamaters');

%save('Results\sol_sameSpecies_shallowGradient.mat', 'populations', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
