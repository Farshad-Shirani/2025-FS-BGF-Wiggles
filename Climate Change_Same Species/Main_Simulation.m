...
%% Initialization ===========================================================================================
[initialPopulations, modelParameters, simulationParameters, discretizationParamaters, epsilon, eta] = initializeSimulation;
global Q_opt

shiftAmplitude = 5; % amplitude of climatic shift in Q_opt 
shiftDuration = 10; % duration of time over which the total shift occures, from 0 to shiftAmplitude, with linear increase
...
%     plot(fig6, x, solution(:,6));
    ...
    %---Climate change: Shifting up Q_opt-----------------------------------------
    if t(k) < shiftDuration
        Q_opt = Q_opt + shiftAmplitude * Dt / shiftDuration;
    end    
...
%save('Results\sol_climateChange_sameSpecies_10_5.mat', 'populations', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
