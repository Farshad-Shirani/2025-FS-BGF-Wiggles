...
%load('Results\sol_sameSpecies_gradient_0_5.mat')
load('Results\sol_sameSpecies_gradient_1.mat')
...
Q1_edgeIndex = dsearchn(x', 70); % N1(:,end)=0 at approximately x=47
Q2_edgeIndex = dsearchn(x', 0); % N2(:,end)=0 at approximately x=23
